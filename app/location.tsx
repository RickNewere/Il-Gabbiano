      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.transportContainer}>
            ...
            <View style={styles.transportCard}>
              ...
              <Text style={styles.transportText}>
                {language === 'it'
                  ? "L'aeroporto più vicino è quello di Bari-Palese, a circa 60 km. Dall'aeroporto è possibile prendere un treno o un autobus per Monopoli, oppure noleggiare un'auto."
                  : "The nearest airport is Bari-Palese, about 60 km away. From the airport, you can take a train or bus to Monopoli, or rent a car."}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.poiContainer}>
            ...
            <View style={styles.poiItem}>
              <Text style={styles.poiName}>{language === 'it' ? "Porto di Monopoli" : "Monopoli Port"}</Text>
              <Text style={styles.poiDistance}>{language === 'it' ? "500 m - 6 minuti a piedi" : "500 m - 6 minutes walking"}</Text>
            </View>
          </View>
        </View>
